...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMessagePayBtn = (Button) findViewById(R.id.message_pay_button);
        ...
        QQ5Sdk.getInstance().init(MainActivity.this, QQ5Sdk.HORIZONTAL, "2", "IilaQXIbzG2WFtKL", result, new SplashDismissCallBack() {
            ...
            public void onDismiss() {
                ...
                mMessagePayBtn.setEnabled(true);
                //方法将在初始化完毕时调用
            }
        });

        //init 方法重载，不传splashVisibility 默认开启闪屏
//        QQ5Sdk.getInstance().init(MainActivity.this, QQ5Sdk.VERTICAL, "2", "IilaQXIbzG2WFtKL", new SplashDismissCallBack() {
//            @Override
//            public void onDismiss() {
//                setText("初始化回调成功");
//                //方法将在初始化完毕时调用
...
//        });
    ...
    public void pay(View view) {
         ...
         */
        QQ5Sdk.getInstance().onPay(this, System.currentTimeMillis() + "", "", "刀币", amount, "", new PayCallBack() {
            @Override
    ...
    public void messagePay(View view) {
    	/**
         * 短代支付接口
         * 支付回调监听器。
         *
         ...
         * @param payCallBack 支付回调接口
         */
        QQ5Sdk.getInstance().onPay(this, "0", new PayCallBack() {
            @Override
            public void failed(String message) {
                setText("支付失败！原因:" + message);
            }
